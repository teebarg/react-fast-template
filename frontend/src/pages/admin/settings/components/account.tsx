        ...
        <React.Fragment>
            <div className="py-2">
                <div>
                    ...
                    <TextField name="name" register={register} error={errors?.name} placeholder="e.g Kate Moore" />
                </div>
                ...
                <div>
                    ...
                    <TextField name="username" register={register} error={errors?.username} placeholder="kate.moore" />
                </div>
                <span aria-hidden="true" className="w-px h-px block" style={{ marginLeft: "0.25rem", marginTop: "0.5rem" }} />
                <div>
                    ...
                    <TextField name="email" type="email" register={register} error={errors?.email} placeholder="e.g kate.moore@acme.com" />
                </div>
                <span aria-hidden="true" className="w-px h-px block" style={{ marginLeft: "0.25rem", marginTop: "0.5rem" }} />
                <div>
                    <div>
