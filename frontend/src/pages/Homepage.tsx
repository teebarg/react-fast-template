        ...
        <React.Fragment>
            ...
            <div className="flex flex-col min-h-screen">
                ...
                <main className="flex-1">
                    ...
                    <div className="bg-content3 py-4 px-6">
                        <div className="mx-auto w-full max-w-6xl px-6 py-20 sm:py-32 lg:px-8 lg:py-40">
                            <div>
                                <div
                                    className="data-[left-scroll=true]:[mask-image:linear-gradient(270deg,#000_calc(100%_-_var(--scroll-shadow-size)),transparent)] data-[right-scroll=true]:[mask-image:linear-gradient(90deg,#000_calc(100%_-_var(--scroll-shadow-size)),transparent)] data-[left-right-scroll=true]:[mask-image:linear-gradient(to_right,#000,#000,transparent_0,#000_var(--scroll-shadow-size),#000_calc(100%_-_var(--scroll-shadow-size)),transparent)] flex w-full overflow-x-hidden"
                                    data-orientation="horizontal"
                                    data-topB-bottom-scroll="false"
                                    ...
                                    <ScrollShadow className="" orientation="horizontal">
                                        <div className="flex w-max items-stretch gap-[--gap] animate-scrolling-banner hover:[animation-play-state:paused]">
                                            <div className="flex items-center justify-center text-foreground">
                                                <svg fill="none" height="41" viewBox="0 0 168 41" width="168" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M49.2775 28.9524H61.2295V25.3524H53.5255V11.7924H49.2775V28.9524Z" fill="currentColor" />
                                                    <path
                                            ...
                                            <div className="flex items-center justify-center text-foreground">
                                                ...
                                                >
                                                    <path d="M51.2775 29.3232H63.2295V25.7232H55.5255V12.1632H51.2775V29.3232Z" fill="currentColor" />
                                                    <path
                                            ...
                                            <div className="flex items-center justify-center text-foreground">
                                                <svg
                                                    ...
                                                    xmlns="http://www.w3.org/2000/svg"
                                                >
                                                    <path d="M51.8601 28.138H63.8121V24.538H56.1081V10.978H51.8601V28.138Z" fill="currentColor" />
                                                    <path
                                            ...
                                            <div className="flex items-center justify-center text-foreground">
                                                ...
                                                >
                                                    ...
                                                    <path
                                                        ...
                                                        fill="currentColor"
                                                    />
                                                    <path d="M39.317 6.655H42.287V21.108H39.317V6.655Z" fill="currentColor" />
                                                    <path
                                            ...
                                            <div className="flex items-center justify-center text-foreground">
                                                <svg fill="none" height="19" viewBox="0 0 152 19" width="152" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <div className="flex items-center justify-center text-foreground">
                                                <svg fill="none" height="51" viewBox="0 0 100 51" width="100" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M2.58517 29.5165H5.41809V43.4072H2.58517V29.5165Z" fill="currentColor" />
                                                    <path
                                                    ...
                                                    <path
                                                        ...
                                                        fill="currentColor"
                                                    />
                                                    <path d="M22.4061 2.49997H2.60406V22.302H22.4061V2.49997Z" fill="currentColor" />
                                                </svg>
                                            </div>
                                            <div className="flex items-center justify-center text-foreground">
                                                <svg fill="none" height="30" viewBox="0 0 119 30" width="119" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <div className="flex items-center justify-center text-foreground">
                                                <svg fill="none" height="30" viewBox="0 0 160 30" width="160" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M38.5656 1.27465H42.5603V23.0637H49.1333V26.6953H38.5656V1.27465Z" fill="currentColor" />
                                                    <path
                                                    ...
                                                    <path
                                                        ...
                                                        fill="currentColor"
                                                    />
                                                    <path d="M94.1808 1.27465H98.1755V26.6953H94.1808V1.27465Z" fill="currentColor" />
                                                    <path
