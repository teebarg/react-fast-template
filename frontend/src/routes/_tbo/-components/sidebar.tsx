...
const CollectionsSideBar: React.FC<ComponentProps> = () => {
    ...
    return (
        <React.Fragment>
            ...
            <hr className="shrink-0 border-none w-full h-divider my-3" role="separator" />
            <div className="overflow-y-auto -mx-6 h-full px-6 max-h-full pb-6">
            ...
            <div className="flex flex-col gap-3">
                <div>
                    <h3 className="text-large font-medium leading-8 text-foreground mb-1">Size</h3>
                    {/* <p className="text-small text-default-400"></p> */}
                </div>
