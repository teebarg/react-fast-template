...
import { Route as TboImport } from './routes/_tbo'
import { Route as AuthImport } from './routes/_auth'
import { Route as AdminImport } from './routes/_admin'
import { Route as TboTboIndexImport } from './routes/_tbo/tbo.index'
import { Route as TboTboProductImport } from './routes/_tbo/tbo.product'
import { Route as TboTboCollectionsImport } from './routes/_tbo/tbo.collections'
...
const PlaygroundPlaygroundIndexLazyImport = createFileRoute(
...
const TboRoute = TboImport.update({
  id: '/_tbo',
  getParentRoute: () => rootRoute,
} as any)
...
const PlaygroundPlaygroundIndexLazyRoute =
  PlaygroundPlaygroundIndexLazyImport.update({
    path: '/playground/',
    getParentRoute: () => rootRoute,
  } as any).lazy(() =>
    import('./routes/_playground/playground.index.lazy').then((d) => d.Route),
  )
...
const TboTboIndexRoute = TboTboIndexImport.update({
  path: '/tbo/',
  getParentRoute: () => TboRoute,
} as any)
...
const TboTboCheckoutLazyRoute = TboTboCheckoutLazyImport.update({
  ...
  import('./routes/_tbo/tbo.checkout.lazy').then((d) => d.Route),
)
...
const TboTboProductRoute = TboTboProductImport.update({
  path: '/tbo/product',
  getParentRoute: () => TboRoute,
} as any)

const TboTboCollectionsRoute = TboTboCollectionsImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_tbo': {
      ...
      path: ''
      fullPath: ''
      preLoaderRoute: typeof TboImport
      parentRoute: typeof rootRoute
    }
    '/_test': {
      id: '/_test'
    ...
    '/_tbo/tbo/collections': {
      ...
      preLoaderRoute: typeof TboTboCollectionsImport
      parentRoute: typeof TboImport
    }
    '/_tbo/tbo/product': {
      id: '/_tbo/tbo/product'
      path: '/tbo/product'
      fullPath: '/tbo/product'
      preLoaderRoute: typeof TboTboProductImport
      parentRoute: typeof TboImport
    }
    ...
    '/_tbo/tbo/': {
      ...
      path: '/tbo'
      fullPath: '/tbo'
      preLoaderRoute: typeof TboTboIndexImport
      parentRoute: typeof TboImport
    }
    '/_admin/admin/': {
      id: '/_admin/admin/'
...
export const routeTree = rootRoute.addChildren({
  ...
  TboRoute: TboRoute.addChildren({
    TboTboCollectionsRoute,
    TboTboProductRoute,
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_tbo/tbo/collections": {
      "filePath": "_tbo/tbo.collections.tsx",
      "parent": "/_tbo"
    },
    "/_tbo/tbo/product": {
      "filePath": "_tbo/tbo.product.tsx",
      "parent": "/_tbo"
    },
    "/_admin/admin/settings": {
